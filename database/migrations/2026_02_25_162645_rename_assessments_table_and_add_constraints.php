...
return new class extends Migration
{
    ...
    {
        // 1. Rename Tables
        if (Schema::hasTable('assessment_templates')) Schema::rename('assessment_templates', 'simper_templates');
        if (Schema::hasTable('assessment_items')) Schema::rename('assessment_items', 'simper_items');
        if (Schema::hasTable('assessments')) Schema::rename('assessments', 'simper_documents');
        if (Schema::hasTable('assessment_results')) Schema::rename('assessment_results', 'simper_results');
        if (Schema::hasTable('assessment_notes')) Schema::rename('assessment_notes', 'simper_notes');
