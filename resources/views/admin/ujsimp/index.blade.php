...
<div class="container-page">
    <div class="flex flex-col md:flex-row justify-between items-center mb-6">
        <div>
            <h2 class="page-title">Verifikasi UJSIMP</h2>
    ...
    <div class="card-ui mb-6">
        <form action="{{ route('admin.ujsimp.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.ujsimp.index') }}" class="flex-1 btn-ui btn-secondary text-center justify-center">
                    Reset
                </a>
            </div>
        </form>
