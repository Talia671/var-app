...
@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Perusahaan</h2>
    <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Ubah data perusahaan di sistem</p>
</div>
