...
<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Register Logs</h2>
                <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">New user registrations</p>
            </div>
