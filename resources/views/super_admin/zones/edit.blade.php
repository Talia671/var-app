...
@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Zona</h2>
    <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Ubah data zona di sistem</p>
</div>
...
<div class="bg-white dark:bg-night-card rounded-xl shadow-lg border border-gray-100 dark:border-night-border overflow-hidden p-6">
    <form action="{{ route('super-admin.zones.update', $zone->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-4">
