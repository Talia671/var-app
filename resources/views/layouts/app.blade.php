...
<head>
    ...
    @if(Auth::check() && in_array(Auth::user()->role, ['admin','admin_perijinan','super_admin','avp']))
    ...
    <script>
        ...
        // Timezone Detection (Device Location Based)
        (function() {
            try {
                ...
                if (getCookie(cookieName) !== timezone) {
                    document.cookie = cookieName + '=' + timezone + '; path=/; max-age=31536000';
...
<body class="bg-ivory dark:bg-night-bg text-gray-800 dark:text-night-text transition-colors duration-300 font-sans antialiased overflow-x-hidden" x-data="{ sidebarOpen: false, darkMode: localStorage.getItem('theme') === 'dark' }">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col min-w-0 transition-all duration-300">
            ...
            <!-- Page Heading -->
            @isset($header)
                <header class="bg-white dark:bg-night-card shadow-sm border-b border-gray-200 dark:border-night-border mb-6">
