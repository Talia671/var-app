...
<div x-data="{
    ...
    <div class="bg-gradient-to-r from-secondary to-blue-600 rounded-2xl p-8 text-white shadow-lg relative overflow-hidden">
        <div class="relative z-10">
            ...
            <p class="text-blue-100 text-lg mb-6">Panel Viewer (Read-Only)</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <!-- SIMPER CARD -->
        <a href="{{ route('viewer.simper.index') }}" class="group relative bg-white dark:bg-night-card rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-night-border h-48 flex flex-col justify-between p-6">
            ...
            <div class="relative z-10 flex justify-between items-start">
                ...
                <div class="bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-xs font-bold px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity transform translate-x-2 group-hover:translate-x-0">
                    Read Only
                </div>
            </div>
            ...
            <div class="relative z-10">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Lihat Riwayat SIMPER</p>
            </div>
        ...
        <!-- UJSIMP CARD -->
        <a href="{{ route('viewer.ujsimp.index') }}" class="group relative bg-white dark:bg-night-card rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-night-border h-48 flex flex-col justify-between p-6">
            ...
            <div class="relative z-10">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Lihat Riwayat UJSIMP</p>
            </div>
        ...
        <!-- CHECKUP CARD -->
        <a href="{{ route('viewer.checkup.index') }}" class="group relative bg-white dark:bg-night-card rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-night-border h-48 flex flex-col justify-between p-6">
            ...
            <div class="relative z-10">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Lihat Riwayat CheckUp</p>
            </div>
        ...
        <!-- RANMOR CARD -->
        <a href="{{ route('viewer.ranmor.index') }}" class="group relative bg-white dark:bg-night-card rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-night-border h-48 flex flex-col justify-between p-6">
            ...
            <div class="relative z-10">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Lihat Riwayat Ranmor</p>
            </div>
